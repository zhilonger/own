            ...
            <div>
               ...
               {/* 第三部分 */}
                ...
                <div className="com-conter">
                    <Pagination size="small" total={this.state.list.length-1}  pagination={{pageSize:5}} showSizeChanger showQuickJumper className="com-paff" onChange={(e)=>{this.page(e)}}/>
                </div>
                {/* 第三部分 */}
            </div>
        )
