                ...
                <div className='login-box'>
                    <div className='Sign'>
                        ...
                        <div className='form'>
                            ...
                            <div className='tip' style={{display:this.state.nameshow?'block':'none'}}>{this.state.namemsg}</div>
                            <Input placeholder="请输入密码" onBlur={(e)=>{this.passblur(e)}} className='inp' ref='pass'/>
                            <div className='tip' style={{display:this.state.passshow?'block':'none'}}>{this.state.passmsg}</div>
